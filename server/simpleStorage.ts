 ...
 * 
 * A streamlined in-memory storage system that implements the IStorage interface.
 * This replaces the previous PostgreSQL implementation with a lightweight alternative.
 */
