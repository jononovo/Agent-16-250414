      ...
      fields: [
        {
          ...
          label: 'Model',
          type: 'text',
          description: 'Perplexity AI model to use. Recommended: llama-3.1-sonar-small-128k-online, llama-3.1-sonar-large-128k-online, or llama-3.1-sonar-huge-128k-online'
        },
        {
          key: 'apiKey',
          label: 'API Key',
